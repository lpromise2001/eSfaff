		...
		<div id="center">
			<el-form label-position='left'>
				<el-form-item>
					...
					<el-input v-model="foreignLanInfo.staff_no" size="large"></el-input>
				</el-form-item>
				<el-form-item>
					<span>
						<el-icon>
	...
	export default {
		...
		methods: {
			add() {
				...
				console.log(str)
				this.$axios.post("http://localhost:8088/eStaff/foreignLanInfo/infoAdd", this.foreignLanInfo)
					.then(rst => {
						if (rst.data.code == 200) {
							// this.$message("操作结束");
							this.$alert(rst.data.msg, "成功");
							this.$router.push("/ForeignLanSearch")
						} else {
